...
package com.uplexa.upxwallet.util;
...
public class OpenAliasHelperTest {
    ...
    private final static String MONERUJO = "oa1:upx recipient_address=4AdkPJoxn7JCvAby9szgnt93MSEwdnxdhaASxbTBm6x5dCwmsDep2UYN4FhStDn5i11nsJbpU7oj59ahg8gXb1Mg3viqCuk; recipient_name=Monerujo Development; tx_description=Donation to Monerujo Core Team;";
    ...
    public void quotedSemicolon() {
        Map<String, String> attrs = OpenAliasHelper.parse("oa1:upx abc=\";\";def=99;");
        assertNotNull(attrs);
    ...
    public void quotes() {
        ...
        attrs = OpenAliasHelper.parse("oa1:upx abc=\"def\";");
        assertNotNull(attrs);
    ...
    public void duplex() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:upx abc=def;ghi=jkl;");
        assertNotNull(attrs);
        assertTrue(attrs.get("abc").equals("def"));
    ...
    public void quoteMiddle() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:upx abc=d\"ef;ghi=jkl;");
        assertNotNull(attrs);
    ...
    public void quoteMalformedValue() {
        Map<String, String> attrs;
        attrs = OpenAliasHelper.parse("oa1:upx abc=d\"e;f\";ghi=jkl;");
        assertNull(attrs);
    }
