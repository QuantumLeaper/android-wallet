...
public class PeerRetriever implements Callable<PeerRetriever> {
    ...
    static private Section handshakeRequest() {
        ...
        byte[] networkId = Helper.hexToBytes("f1f1006171014161003082a11216a1a1"); // mainnet
        ...
        byte[] genesisHash =
                Helper.hexToBytes("c0b5b2b75795fee292f4ec6fddf772f7605518cf03c976767d53fd63cbe78bb9");
